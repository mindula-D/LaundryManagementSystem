...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-4">
				<em class="fa fa-navicon">&nbsp;</em> Machines <span data-toggle="collapse" href="#sub-item-4" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
				<ul class="children collapse" id="sub-item-4">
					<li><a class="" href="MachinesList.jsp">
						<span class="fa fa-arrow-right">&nbsp;</span> Machine List
					</a></li>
					<li><a class="" href="AddMachine.jsp">
						<span class="fa fa-arrow-right">&nbsp;</span> Add Machine
					</a></li>
					<li><a class="" href="#">
						<span class="fa fa-arrow-right">&nbsp;</span> Setting
					</a></li>
