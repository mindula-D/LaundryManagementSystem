    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <form action="UpdatePaymentCustomer" method="post">
				...
				%>
						...
						<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" value="<%=payment.getPaymentID() %>" readonly="readonly">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="orderid" value="<%=payment.getOrderID() %>" readonly="readonly">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
								<div class="input-group">
                                    <input class="input--style-5" type="text" value="<%=payment.getPayAmount() %>" readonly="readonly">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row p-t-20">
						 ...
						 <div class="form-row">
                            ...
                            <div class="value">
								<div class="input-group">
                                    <input class="input--style-5" type="text" name="description" value="<%=payment.getDescription() %>" required="required">
                                </div>
                            </div>
                        </div>
