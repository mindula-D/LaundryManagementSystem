        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Update Machine Info</h2>
                </div>
                <div class="card-body">
				...
				%>
						...
						<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="MachineID" value="<%=machine.getMachineID() %>" readonly="readonly">
                                </div>
                            </div>
                        </div>
						
                 		<div class="form-row">
                            <div class="name">Machine Brand</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="MachineBrand" value="<%=machine.getMachineBrand() %>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="Condition" value="<%=machine.getCondition() %>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="name">Slot Number</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="SlotNo" value="<%=machine.getSlotNo() %>">
                                </div>
                            </div>
                        </div>
